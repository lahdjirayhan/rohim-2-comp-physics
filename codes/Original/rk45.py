...
graph1 = gdisplay(width=600, height=600, title="RK 45", xtitle="t", ytitle="Y[0]")
funct1 = gcurve(color=color.blue)
graph2 = gdisplay(width=500, height=500, title="RK45", xtitle="t", ytitle="Y[1]")
...
while t < b:  # Loop over time
    ...
    for i in range(0, 2):
        ydumb[i] = (
            y[i] + 1932 * k1[i] / 2197 - 7200 * k2[i] / 2197.0 + 7296 * k3[i] / 2197
        )
