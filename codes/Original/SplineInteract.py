...
x = array([0.0, 0.12, 0.25, 0.37, 0.5, 0.62, 0.75, 0.87, 0.99])  # input
...
u = zeros((n), float)
graph1 = gdisplay(
    x=0, y=0, width=500, height=500, title="Spline Fit", xtitle="x", ytitle="y"
)
