...
scene = canvas( x=0, y=0, width=600, height=400, range=200, title="Circular Polarized E (white) & H (yellow) Fields", )
global phy, pyx
max = 201
...
for i in range(0, max, 10):
    Earrows.append(arrow(pos=vector(0, i - 100, 0), axis=vector(0, 0, 0), color=arrowcol))
    Harrows.append(arrow(pos=vector(0, i - 100, 0), axis=vector(0, 0, 0), color=color.yellow))
