...
n = 100
M = []
DD = []  # Arrays for polymer & grid

graph1 = display(width=Maxx, height=Maxy, title="Protein Folding", range=ran)
    ...
    while (
        ...
        while j == (size - 1) and i != 0 and i != (size - 1):
            ...
            if (i == 0 or i == (size - 1)) or (
                grid[i - 1, size - 1] != 0 and grid[i + 1, size - 1] != 0
            ):
                break
        while j == 0 and i != 0 and i != (size - 1):  # First row
            ...
            if (
                i == (size - 1)
                or i == 0
                or (grid[i - 1, 0] != 0 and grid[i + 1, 0] != 0)
            ):
                break
        while i == 0 and j != 0 and j != (size - 1):  # First column
            ...
            if (
                j == (size - 1)
                or j == 0
                or (grid[0, j + 1] != 0 and grid[0, j - 1] != 0)
            ):
                break
        while i == (size - 1) and j != 0 and j != (size - 1):  # Last col
            ...
            if grid[i, j] == 0:
                ...
                yol = yp
            if j == (size - 1) or (
                grid[size - 1, j + 1] != 0 and grid[size - 1, j - 1] != 0
            ):
                break
