...
E = 0            #210                    # Magnitude E field
g = display(width=500,height=250,title='Wave packet in harmonic well plus electric field',range=10)
...
V = 25.*xs**2-E*xs         #25                # Electric potential
